...
shinyUI(
			...
			column(3,
	          ...
	          tabPanel("Zeitspanne", value = "timerange", 
	          	...
	          	tabPanel("Zeitpunkte", value = "timepoints", 
	          					 ...
	          					 actionButton("checkAllYears", label = "Alle Jahre auswählen"),
	          					 ...
	          					 actionButton("checkAllMonths", label="Alle Monate auswählen"),
	          				 checkboxGroupInput("weekdays", "Wähle Wochentage:", inline = TRUE, selected = '3', choices = c("Montag" = '1', "Dienstag" = '2', "Mittwoch" = '3', "Donnerstag" = '4', "Freitag" = '5', "Samstag" = '6', "Sonntag" = '0')),
	          					 actionButton("checkAllWeekdays", label = "Alle Wochentage auswählen")
	  				)
					 )
	  			),
			column(5,
	...
	fluidRow(
		...
		a("(mehr Infos zur Lizenz hier)", href = "https://github.com/codeformuenster/traffic-dynamics#rechtliches"),
		HTML("<br>"),
		print("Datenquelle: Stadt Münster (lizenziert unter Datenlizenz Deutschland - Namensnennung - Version 2.0)"),
		a("(weitere Infos zu den Daten hier)", href = "http://www.stadt-muenster.de/verkehrsplanung/verkehr-in-zahlen.html")
	)
)
)
)
